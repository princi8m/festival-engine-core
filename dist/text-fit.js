...
exports.bestTwoLineSplit = bestTwoLineSplit;
exports.wrapToFit = wrapToFit;
exports.fitAdaptiveText = fitAdaptiveText;
exports.fitOverrideText = fitOverrideText;
...
function bestTwoLineSplit(text, measure, size, maxW) {
...
function wrapToFit(text, measure, size, maxW) {
    const words = text.split(" ");
    const lines = [];
    let current = "";
 ...
 */
function fitAdaptiveText(text, measure, opts) {
...
function fitOverrideText(text, measure, opts) {
...
//# sourceMappingURL=text-fit.js.map